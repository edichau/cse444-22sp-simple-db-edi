    ...
    */
    ...
    public void insertTuple(Tuple t) throws DbException {
        ...
        if (getNumEmptySlots() == 0) {
            throw new DbException("Page if full");
        }
        int pos = IntStream.range(0, tuples.length)
                .filter(i -> tuples[i] == null)
                .findFirst()
                .orElseThrow(() -> new DbException("Page is full"));
    ...
    public TransactionId isDirty() {
        return (dirty) ? dirtyTransaction : null;
    }
    ...
    private void markSlotUsed(int i, boolean value) {
        header[i / 8] = (byte) (value ? header[i / 8] | (1 << i % 8) : header[i / 8] & ~(1 << i % 8));
    }
    ...
    public Iterator<Tuple> iterator() {
        // Returns iterator on tuples with slots that are used
